    ...
    <div class="page-topbar row items-center q-px-xl q-py-md">
      ...
      <div class="col">
        <q-breadcrumbs class="breadcrumb-nav" active-color="primary" separator="›">
          ...
          <q-breadcrumbs-el label="Fornecedores" to="/stock/suppliers" class="breadcrumb-link" />
          <q-breadcrumbs-el label="Criar Fornecedor" class="breadcrumb-active" />
        </q-breadcrumbs>
      ...
      <q-card class="form-card" flat>
        ...
        <div class="form-card-header row items-center q-px-lg q-py-md">
          <div class="form-header-icon q-mr-md">
            <q-icon name="local_shipping" size="1.2rem" color="white" />
          </div>
          <div>
            <div class="form-header-title">Criar Fornecedor</div>
            <div class="form-header-sub">Preencha os campos abaixo para registar o novo fornecedor</div>
          </div>
        </div>
        ...
        <q-card-section class="q-pa-lg">
          <q-form ref="formRef" @submit.prevent="handleSubmit">
            ...
            <div class="section-label q-mb-md">Informações do Fornecedor</div>

            <div class="row q-col-gutter-md q-mb-lg">

              <!-- Nome -->
              <div class="col-md-6 col-12">
                <div class="field-label">Nome do Fornecedor <span class="required">*</span></div>
                <q-input
                  v-model="form.name"
...
const handleSubmit = async () => {
  ...
  loading.value = true;
  try {
    await inventoryStores.createProductSupplier({ ...form.value });
