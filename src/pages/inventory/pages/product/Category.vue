    ...
    <div class="page-topbar row items-center q-px-xl q-py-md">
      ...
      <div class="col">
        <q-breadcrumbs class="breadcrumb-nav" active-color="primary" separator="›">
          ...
          <q-breadcrumbs-el label="Categorias de Produtos" class="breadcrumb-active" />
        </q-breadcrumbs>
            ...
            >
              ...
              <div class="grid-card-body">
                ...
                <div class="grid-info row items-center q-gutter-xs q-mt-xs">
                  <q-icon name="inventory_2" size="0.9rem" color="grey-5" />
                  <span>{{ category.productsCount ?? 0 }} produto(s)</span>
                </div>
              </div>
...
const stats = computed(() => [
  ...
  {
    label: "Com Produtos",
    value: categories.value.filter((c) => c.productsCount > 0).length,
    icon: "inventory_2",
    color: "#21b573",
  },
  {
    label: "Sem Produtos",
    value: categories.value.filter((c) => !c.productsCount || c.productsCount === 0).length,
    icon: "warning",
    color: "#f57c00",
  },
]);
...
const editCategory = (category) => {
  router.push({ name: "stock-categories-edit", params: { id: category.id } });
};
